...
1. Electron main owns native dialogs, revisioned local configuration, locked Knowledge installation, plugin policy, knowledge-root validation, and bounded Harness restart/rollback.
